...
- (void)testInstanceWithName {
    Amplitude *a = [Amplitude instanceWithServerURLString:@"https://test.com/"
                                    europeServerURLString:@"https://eu-test.com/"];
    Amplitude *b = [Amplitude instanceWithName:@""] serverURLString:@"https://test.com/"
europeServerURLString:@"https://eu-test.com/";
    Amplitude *c = [Amplitude instanceWithName:nil serverURLString:@"https://test.com/"
                         europeServerURLString:@"https://eu-test.com/"];
    Amplitude *e = [Amplitude instanceWithName:kAMPDefaultInstance serverURLString:@"https://test.com/"
                         europeServerURLString:@"https://eu-test.com/"];
    Amplitude *f = [Amplitude instanceWithName:@"app1" serverURLString:@"https://test.com/"
                         europeServerURLString:@"https://eu-test.com/"];
    Amplitude *g = [Amplitude instanceWithName:@"app2" serverURLString:@"https://test.com/"
                         europeServerURLString:@"https://eu-test.com/"];
    ...
    XCTAssertEqual(c, e);
    XCTAssertEqual(e, a);
    XCTAssertEqual(e, [Amplitude instanceWithServerURLString:@"https://test.com/"
                                       europeServerURLString:@"https://eu-test.com/"]);
    XCTAssertNotEqual(e,f);
    XCTAssertEqual(f, [Amplitude instanceWithName:@"app1" serverURLString:@"https://test.com/"
                            europeServerURLString:@"https://eu-test.com/"]);
    XCTAssertNotEqual(f,g);
    XCTAssertEqual(g, [Amplitude instanceWithName:@"app2" serverURLString:@"https://test.com/"
                            europeServerURLString:@"https://eu-test.com/"]);
}

- (void)testInitWithInstanceName {
    Amplitude *a = [Amplitude instanceWithName:@"APP1"
                               serverURLString:@"https://test.com/"
                         europeServerURLString:@"https://eu-test.com/"];
...
- (void)testSeparateInstancesLogEventsSeparate {
    ...
    [[Amplitude instanceWithServerURLString:@"https://test.com/"
                      europeServerURLString:@"https://eu-test.com/"] setDeviceId:@"oldDeviceId"];
    [[Amplitude instanceWithServerURLString:@"https://test.com/"
                      europeServerURLString:@"https://eu-test.com/"] flushQueue];
    XCTAssertEqualObjects([oldDbHelper getValue:@"device_id"], @"oldDeviceId");
    XCTAssertEqualObjects([[Amplitude instanceWithServerURLString:@"https://test.com/"
                                            europeServerURLString:@"https://eu-test.com/"] getDeviceId], @"oldDeviceId");
    XCTAssertEqual([[Amplitude instanceWithServerURLString:@"https://test.com/"
                                     europeServerURLString:@"https://eu-test.com/"] getNextSequenceNumber], 1001);
    ...
    [[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] initializeApiKey:newApiKey1];
    [[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] flushQueue];
    XCTAssertNotEqualObjects([[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
                                    europeServerURLString:@"https://eu-test.com/"] getDeviceId], @"oldDeviceId");
    XCTAssertEqualObjects([[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
                                 europeServerURLString:@"https://eu-test.com/"] getDeviceId], [newDBHelper1 getValue:@"device_id"]);
    XCTAssertEqual([[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
                          europeServerURLString:@"https://eu-test.com/"] getNextSequenceNumber], 1);
    ...
    [[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] initializeApiKey:newApiKey2];
    [[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] flushQueue];
    XCTAssertNotEqualObjects([[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
                                    europeServerURLString:@"https://eu-test.com/"] getDeviceId], @"oldDeviceId");
    XCTAssertEqualObjects([[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
                                 europeServerURLString:@"https://eu-test.com/"] getDeviceId], [newDBHelper2 getValue:@"device_id"]);
    XCTAssertEqual([[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
                          europeServerURLString:@"https://eu-test.com/"] getNextSequenceNumber], 1);
    ...
    [[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] setDeviceId:@"fakeDeviceId"];
    [[Amplitude instanceWithName:newInstance1 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] flushQueue];
    ...
    [[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] setDeviceId:@"brandNewDeviceId"];
    [[Amplitude instanceWithName:newInstance2 serverURLString:@"https://test.com/"
           europeServerURLString:@"https://eu-test.com/"] flushQueue];
    XCTAssertEqualObjects([newDBHelper1 getValue:@"device_id"], @"fakeDeviceId");
...
- (void)testInitializeLoadUserIdFromEventData {
    ...
    Amplitude *client = [Amplitude instanceWithName:instanceName serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
    [client flushQueue];
...
- (void) test{
    ...
    [[Amplitude instanceWithServerURLString:@"https://test.com/"
                      europeServerURLString:@"https://eu-test.com/"] logEvent:@"Completed Purchase" withEventProperties:event_properties];
}
...
-(void)testIdfaAsDeviceId {
    ...
    Amplitude *client = [Amplitude instanceWithName:@"idfa" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
-(void)testIdfvAsDeviceId {
    ...
    Amplitude *client = [Amplitude instanceWithName:@"idfv" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
-(void)testDisableIdfvAsDeviceId {
    ...
    Amplitude *client = [Amplitude instanceWithName:@"disable_idfv" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
    [client flushQueueWithQueue:client.initializerQueue];
    [client setTrackingOptions:options];
    [client initializeApiKey:@"api key"];
...
- (void)testCustomizedLibrary {
    Amplitude *client = [Amplitude instanceWithName:@"custom_lib" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
- (void)testCustomizedLibraryWithNilVersion {
    ...
    NSDictionary *event = [client getLastEventFromInstanceName:@"custom_lib" serverURLString:@"https://test.com/"
                                         europeServerURLString:@"https://eu-test.com/"];
    NSDictionary *targetLibraryValue = @{ @"name" : @"amplitude-unity",
...
- (void)testSetPlan {
    Amplitude *client = [Amplitude instanceWithName:@"observe_plan" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
- (void)testSetIngestionMetadata {
    Amplitude *client = [Amplitude instanceWithName:@"ingestion_metadata" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
- (void)testSetServerZone {
    Amplitude *client = [Amplitude instanceWithName:@"eu_zone" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
- (void)testSetServerZoneWithoutUpdateServerUrl {
    Amplitude *client = [Amplitude instanceWithName:@"eu_zone_2" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
    XCTAssertEqualObjects(kAMPEventLogUrl, [client valueForKey:@"serverUrl"]);
    [client initializeApiKey:@"eu_api_key"];
...
- (void)testMiddlewareSupport {
    ...
    Amplitude *client = [Amplitude instanceWithName:@"middleware_support" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
- (void)testSwallowMiddleware {
    ...
    Amplitude *client = [Amplitude instanceWithName:@"middleware_swallow" serverURLString:@"https://test.com/"
                              europeServerURLString:@"https://eu-test.com/"];
...
-(void)testSetIdentifyUploadSecondsOnUninitializedClient {
    ...
    Amplitude *uninitializedClient = [Amplitude instanceWithName:instanceName serverURLString:@"https://test.com/"
                                           europeServerURLString:@"https://eu-test.com/"];
